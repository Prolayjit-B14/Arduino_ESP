...
const char* ssid = "Redmi Note 11 Pro+ 5G";       // Your WiFi network name (SSID)
const char* password = "@polu1411P";   // Your WiFi network password
...
// API Authentication
const char* apiKey = "jDzlBeB3enDB";    // Your unique GeoLinker API key
